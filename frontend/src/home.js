...
//             let res = await axios({
//                 method: "post",
//                 url: ProcessingInstruction.env.REACT_APP_API_URL,
//                 data: formData,
//             });
//             if (res.status == 200) {
//                 setData(res.data);
...
export const ImageClassification = () => {
    ...
    return (
      <div className="image-classification">
        ...
        <button onClick={handleClassify} disabled={!imageFile}>Classify</button>
        {classificationResult && (
          <div>
            <p>Classified Class: {classificationResult.class}</p>
